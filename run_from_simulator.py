...
if __name__ == "__main__":
    ...
    for i in range(num_sim):
        ...
        scorer = es.exp_scores.create_from_error_frac(sim_params['pos_error_frac'],
                                                      np_ratio)
        ...
        gai = ga.graph_algorithm(init_edges, init_clusters, aug_names,
                                 ga_params, sim_i.augmentation_request,
                                 sim_i.augmentation_result, log_file)

        gai.set_trace_compare_to_gt_cb(sim_i.trace_start_human,
                                       sim_i.trace_iter_compare_to_gt)
