...
# ibs.ibeis_lca_hello_world() in this file, you can call
#
#     python -m ibeis_lca._plugin --test-ibeis_lca_hello_world:0
#
...
#
#     python -m ibeis_lca._plugin --test-ibeis_lca_file_download:1 --profile
#
...
# something like this:
#
#     **[TEST.FINISH] ibeis_lca_file_download -- SUCCESS
#     [util_io] * Writing to text file: timeings.txt
#     L_____________________________________________________________
#     +-------
#     | finished testing fpath='ibeis_lca/ibeis_lca/_plugin.py'
#     | passed 1 / 1
#     L-------
#     Dumping Profile Information
#      -1.00 seconds - None                                             :None:None
#       0.14 seconds - ibeis_lca_file_download:ibeis_lca/ibeis_lca/_plugin.py:536
...
#     587         2     136968.0  68484.0     99.9          file_filepath = ut.grab_file_url(file_url, appname='ibeis_lca', check_hash=True)
#     588
...
# that uses ut.embed() in the ibs.ibeis_lca_hello_world()
...
def ibeis_lca_hello_world(ibs):
    ...
    CommandLine:
        ...
        python -m ibeis_lca._plugin --test-ibeis_lca_hello_world:1
    ...
    Example0:
        ...
        >>> resp = ibs.ibeis_lca_hello_world()
        >>>
...
@profile
@register_ibs_method
def ibeis_lca_file_download(file_url):
    r"""
    ...
    CommandLine:
        python -m ibeis_lca._plugin --test-ibeis_lca_file_download

        python -m ibeis_lca._plugin --test-ibeis_lca_file_download:0

        python -m ibeis_lca._plugin --test-ibeis_lca_file_download:1
    ...
    Example1:
        ...
        >>> file_filepath_ = ibeis_lca_file_download(file_url)
    ...
    with ut.Timer() as timer:
        file_filepath = ut.grab_file_url(file_url, appname='ibeis_lca', check_hash=True)
...
class IdentificationExampleImageHashConfig(dt.Config):  # NOQA
    """
    CommandLine:
        python -m ibeis_lca._plugin --test-IdentificationExampleImageHashConfig

        python -m ibeis_lca._plugin --test-IdentificationExampleImageHashConfig:0

        python -m ibeis_lca._plugin --test-IdentificationExampleImageHashConfig:1
...
def ibeis_lca_image_hash(depc, gid_list, config):
    ...
    CommandLine:
        python -m ibeis_lca._plugin --test-ibeis_lca_image_hash
...
class IdentificationExampleImageHashSumConfig(dt.Config):  # NOQA
    """
    CommandLine:
        python -m ibeis_lca._plugin --test-IdentificationExampleImageHashSumConfig
...
def ibeis_lca_image_hash_sum(depc, image_hash_rowid_list, config):
    ...
    CommandLine:
        python -m ibeis_lca._plugin --test-ibeis_lca_image_hash_sum
...
class IdentificationExampleImageHashProdConfig(dt.Config):  # NOQA
    """
    CommandLine:
        python -m ibeis_lca._plugin --test-IdentificationExampleImageHashProdConfig
...
def ibeis_lca_image_hash_prod(depc, image_hash_rowid_list, config):
    ...
    CommandLine:
        python -m ibeis_lca._plugin --test-ibeis_lca_image_hash_prod
...
class IdentificationExampleOracleRequest(dt.base.VsOneSimilarityRequest):  # NOQA
    ...
    CommandLine:
        python -m ibeis_lca._plugin --test-IdentificationExampleOracleRequest
...
class IdentificationExampleOracleConfig(dt.Config):  # NOQA
    """
    CommandLine:
        python -m ibeis_lca._plugin --test-IdentificationExampleOracleConfig
...
def ibeis_lca_oracle(depc, qaid_list, daid_list, config):
    ...
    CommandLine:
        python -m ibeis_lca._plugin --test-ibeis_lca_oracle:0

        python -m ibeis_lca._plugin --test-ibeis_lca_oracle:0 --show

        python -m ibeis_lca._plugin --test-ibeis_lca_oracle:1

        python -m ibeis_lca._plugin --test-ibeis_lca_oracle:2

        python -m ibeis_lca._plugin --test-ibeis_lca_oracle:3
